...
import kotlinx.android.synthetic.main.referrals_code.*
...
class ShareReferlCode : LocaleAwareCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.referrals_code)
        mContext = this@ShareReferlCode
...
//            referalcode
            val body = "Welcome to Mauto"
            val sub = "Your Subject"
            shareData.putExtra(Intent.EXTRA_SUBJECT, sub)
            shareData.putExtra(Intent.EXTRA_TEXT, body)
