...
class otptripupdatecallapi : IntentService("ApiHit")
{
...
//            }
            ...
            header.put("distance",mSessionManager.getdistance_km_otp())
            Log.d("dfzdsfdg", mSessionManager.getdistance_km_otp())


//            header.put("distance",)
            Log.d("cjshshhs", header.toString())
            // url to hit
    ...
    fun getallrecordforparticularrideid(ride_id:String):ArrayList<ArrayList<String>>
    {
        ...
        val curser = mHelper.getLatLongForOtpRide()
