...
//import java.util.*
//
//class PaymenttypeCustomAdapter(var context: Context, var languages: ArrayList<String>) : BaseAdapter() {
...
//         convertView = inflater.inflate(R.layout.spinner_paymenttype, null)
