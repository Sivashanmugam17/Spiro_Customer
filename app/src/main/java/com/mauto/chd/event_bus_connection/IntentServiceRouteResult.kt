...
class IntentServiceRouteResult internal constructor(resultCode: Int, resultValue: PolylineOptions, wayPointsBuilder: LatLngBounds.Builder, routeLatLngArray: ArrayList<LatLng>) {
