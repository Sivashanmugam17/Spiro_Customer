...
//
//
//class riderequestpage_BACKUP : LocaleAwareCompatActivity(), OnMapReadyCallback {
//
...
//        }
//        mContext = this@riderequestpage_BACKUP
...
//    class riderequestjava(private val mContext: Context,private val loader:SmoothProgressBar, private val mDatas: MutableList<ItemInfo>, mCustomOnClickListener: Requestlistener) : RecyclerView.Adapter<MyViewHolder>() {
