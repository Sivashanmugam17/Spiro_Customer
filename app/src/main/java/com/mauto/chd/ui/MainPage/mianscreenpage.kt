...
//import cabily.handyforall.dinedoo.BuildConfig
//import cabily.handyforall.dinedoo.R
//import cabily.handyforall.dinedoo.databinding.Mainpage1designBinding
...
////import kotlinx.android.synthetic.main.activity_earnings.progress_lay
...
////import kotlinx.android.synthetic.main.maipagedesign.changestatus
//import kotlinx.android.synthetic.main.maipagedesign.coordinate_bottom_sheet_ride_book_now
//import kotlinx.android.synthetic.main.maipagedesign.drawer_layout
////import kotlinx.android.synthetic.main.maipagedesign.gotext
//import kotlinx.android.synthetic.main.maipagedesign.iv_line
////import kotlinx.android.synthetic.main.maipagedesign.layout_ripplepulse3
////import kotlinx.android.synthetic.main.maipagedesign.loader
////import kotlinx.android.synthetic.main.maipagedesign.offbut
////import kotlinx.android.synthetic.main.maipagedesign.offlineclick3
////import kotlinx.android.synthetic.main.maipagedesign.offlineripple
////import kotlinx.android.synthetic.main.maipagedesign.profileeclick
...
//
//class mianscreenpage : LocaleAwareCompatActivity(), OnMapReadyCallback, DrawerAdapter.OnItemSelectedListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
//
//
...
//    lateinit var binding: Mainpage1designBinding
...
//        binding = DataBindingUtil.setContentView(this, R.layout.mainpage1design)
//        mContext = this@mianscreenpage
...
//    }
//
//    fun checkdriverBound(){
//        val city = LatLng(13.0429838 , 80.2736914)
//        var latLngB = LatLng(13.0429838,  80.2736914)
//
//
////        var bounds = LatLngBounds(pts[1], pts[1])
//
//        val contains1 = PolyUtil.containsLocation(LatLng(mSessionManager!!.getOnlineLatitiude().toDouble(),mSessionManager!!.getOnlineLongitude().toDouble()), pts, true)
////        println("contains1: $contains1")
//        Log.d("mcontainsm2", contains1.toString())
//        Log.d("maaqqnew", mSessionManager!!.getOnlineLatitiude().toDouble().toString())
////        val contains2: Boolean = bounds.contains(city)
//        if (contains1.equals("false")) {
//
//        }
//        if (check.equals("1")){
//            check="0"
//            getgeofenceupdate(contains1.toString())
//        }
//
//    }
...
//        val aIntent = Intent(this, commonapifetchservice::class.java)
//        aIntent.putExtra(getString(R.string.intent_putextra_api_key), getString(R.string.geofence_update))
...
//                                runOnUiThread {
//                                    progress_time_pic.visibility = View.GONE
//                                    rounded_iv_1.setImageBitmap(resource)
//                                }
//                            }
//
...
////                profileeclick.visibility=View.VISIBLE
////                layout_ripplepulse3.visibility = View.GONE
...
////                layout_ripplepulse3.startRippleAnimation()
////                offlineripple.visibility = View.GONE
//                profileeclick.visibility=View.INVISIBLE
//                if (viewModel.isMyServiceRunning(mContext, OnlineJobService::class.java)) {
//                    stoponlineservice()
//                    animationstop()
//                }
