...
public class TrackingPageGooglemap
{
    ...
    public TrackingPageGooglemap(Context context) {
        mContext = context;
    ...
    public void addTo(final GoogleMap googleMap, Bitmap driver_marker_resized,int mode) {
        addTo(googleMap, new GpsMyLocationProvider(mContext,mode), driver_marker_resized);
    }
            ...
            public void onLocationChanged(final Location location, MyLocationProvider source) {
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.d("current_lats202",location.getLatitude()+"   "+location.getLongitude());
                        ...
                        {
                            count++;
                            mSessionManager.setTrackinPagesession(location.getLatitude(),location.getLongitude(),location.getBearing(),""+radius,""+count);
                        }
